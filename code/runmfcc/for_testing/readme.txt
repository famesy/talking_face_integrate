...
2. Installing the runmfcc Package

A. Change to the directory that contains the file setup.py and the subdirectory runmfcc. 
...
3. Using the runmfcc Package

The runmfcc package is on your Python path. To import it into a Python script or session, 
execute:
