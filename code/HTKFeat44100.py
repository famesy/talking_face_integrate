...
class MFCC_HTK:
    ...
    def load_filter(self, filename):
        ...
        self.filter_mat = np.zeros((int(self.fft_len / 2), self.filter_num))
    ...
    def __init__(self,
        ...
        self.win_len = int(0.025*self.samp_freq)
        self.win_shift = int(0.01*self.samp_freq)
        self.preemph = preemph
        self.filter_num = filter_num
        self.lifter_num = lifter_num
        ...
        """ Class contructor -- you can set all the processing parameters here.
            ...
            Args:
                ...
                samp_freq (int): Sampling frequency of the audio. Default value is 16000, which is
                    ...
                    is half of this value, i.e. 44100 Hz.
        ...
        if filter_file:
            ...
            self.create_filter(self.filter_num)
